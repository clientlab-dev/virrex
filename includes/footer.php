...
<footer class="footer">
    <div class="footer__wrap wrap">
        ...
        <div class="footer__col footer__col--5">
            <ul class="footer__list">
                ...
                <li class="footer__list-item footer__top-list-item">
                    <a href="#" class="footer__list-item-image"><img src="assets/img/google-play.png" alt="google-play"></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="footer__info">
        <div class="footer__site-name">© 2017 Virrex.io</div>
            <div class="footer__made-by">
                <!-- <div class="footer__info-right-text">
                    <p>Разработка и продвижение</p>
                    <p>«КлиентЛаб»</p>
                </div>
                <img src="assets/img/client-lab.png" alt=""> -->
	...
	<meta charset="UTF-8">
	<a title="Разработка и продвижение сайта от КлиентЛаб" target="_blank" rel="noopener" class="clientlab-copyright-link" href="https://clientlab.ru/nashi-raboti/virrex/" style="border: 0; color: #000; font: inherit; font-size: 100%; margin: 0; padding: 0; text-decoration: none; vertical-align: baseline;">
